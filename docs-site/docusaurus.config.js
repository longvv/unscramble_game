    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/longvv/unscramble_game/tree/main/docs/',
        },
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            type: 'docSidebar',
            sidebarId: 'docsSidebar', // Match this with the ID in sidebars.js
            position: 'left',
            label: 'Documentation',
          },
          {
            href: 'https://github.com/longvv/unscramble_game',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub Issues',
                href: 'https://github.com/longvv/unscramble_game/issues',
              }
            ],
          },
        ],
